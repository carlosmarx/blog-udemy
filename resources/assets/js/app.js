...
Vue.component('top-nav', require('./components/Topo.vue'));
...
Vue.component('breadcumbs', require('./components/Breadcumbs.vue'));
Vue.component('modal', require('./components/modal/Modal.vue'));
Vue.component('button-modal', require('./components/modal/ButtonModal.vue'));
